 ...
 * representan las Películas en el sistema.
 * @author Grupo RMBJ
 * @version 3.0
 * @since 1.0
 */
...
public class PeliculaDTO implements Serializable {
	...
	/**
	 * Representa el año de estreno de una película. Se ha mantenido como
	 * atributo "int" por simplicidad.
	 */
	private int anyo;
	/**
	 * Representa un String con el nombre y apellido o pseudónimo del
	 * director de la película. Se ha entendido que habrá un único director
	 * por película por simplicidad, dado que no es lo más habitual ver
	...
	/**
	 * Representa un String con los premios que ha ganado una película
	 * concreta.
	 */
	 ...
	 * han participado en esta película. Se ha evitado generar esto como una
	 * Lista de Actores DTO, porque generaba una recursividad infinita al
	 * insertar actores y películas actualizados, tal y como está
