...
/**
 * Este bloque de código representa un conjunto de pruebas unitarias con el objetivo de validar que las valoraciones
 * se ejecutan correctamente.
 *
 * Si supone mucho quebradero de cabeza, no se harán estos tests. Solamente se quiere testear que los JOptionPane
 * respectivos envían las valoraciones que se les pide, y que filtra correctamente las valoraciones en el
 * intervalo [1-10].
 *
 * @author Grupo RMBJ
 * @version 3.0
...
//	String testName;
//
//	static Logger logger = Logger.getLogger(ValoracionTest.class.getName());
//
//	@Rule
//	public ContiPerfRule rule = new ContiPerfRule();
//
//	public static junit.framework.Test suite() {
//		return new JUnit4TestAdapter(ValoracionTest.class);
//	}
//
//	@Before
//	public void setUp() {
